...
def create_default_mapper_registry() -> RecordMapperRegistry:
    ...
    definitions: list[tuple[EntityType, type[ChronicleEntity], dict[str, str]]] = [
        ...
        (EntityType.COTERIES, Coterie, {"name": "name", "description": "description", "goals": "goals", "haven": "haven", "importance": "importance", "notes": "notes", **metadata}),
        (EntityType.LOCATIONS, Location, {"name": "name", "level": "level", "parent_city_id": "parentCityId", "sect": "sect", "faction_id": "factionId", "importance": "importance", "description": "description", "notes": "notes", **metadata}),
    ...
    registry.register(
        ...
        DataclassRecordMapper(
            Character,
            {"name": "name", "character_type": "characterType", "species": "species", "vampire_clan": "vampireClan", "garou_tribe": "garouTribe", "status": "status", "importance": "importance", "known_abilities": "knownAbilities", "description": "description", "notes": "notes", "tags": "tags", "aliases": "aliases", "system_tags": "systemTags"},
    ...
    registry.register(
        ...
        DataclassRecordMapper(
            Faction,
            {"name": "name", "faction_type": "factionType", "sect": "sect", "importance": "importance", "description": "description", "goals": "goals", "is_secondary": "isSecondary", "main_faction_id": "mainFactionId", "notes": "notes", "tags": "tags", "aliases": "aliases", "system_tags": "systemTags"},
            readers={"system_tags": _system_tags_from_json},
            writers={"system_tags": _system_tags_to_json},
        ),
    )
    ...
    registry.register(
        ...
        DataclassRecordMapper(
            GraphLayout,
            {"name": "name", "nodes": "nodes", "viewport": "viewport", "mode": "mode", "filters": "filters", "mode_styles": "modeStyles", "mode_layouts": "modeLayouts"},
